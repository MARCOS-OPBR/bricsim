from PyQt5.QtWidgets import (
    QApplication, QMainWindow, QWidget, QHBoxLayout, QVBoxLayout,QMenu,
    QPushButton, QLabel, QLineEdit, QStatusBar, QListWidget, QTabWidget, QFileDialog
)
from PyQt5.QtCore import Qt, QSize
from PyQt5.QtGui import QIcon
import os, sys, json

from canvas_simulator import SimuladorCanvas, TouchAreaItem,VariaveisCentralDialog,LogicaCentralDialog
from functions import carregar_simulacao, salvar_simulacao, carregar_modelo, salvar_modelo, _montar_cena
...
class SimuladorMain(QMainWindow):
    def __init__(self):
        ...
        self.btn_abrir_sim.setIcon(QIcon(os.path.join(base_path, "icons", "open_s.svg")))
        self.btn_abrir_sim.setIconSize(QSize(32, 32))
        self.btn_abrir_mod = QPushButton("ABRIR MOD")
        self.btn_abrir_mod.setIcon(QIcon(os.path.join(base_path, "icons", "open_m.svg")))
        self.btn_abrir_mod.setIconSize(QSize(32, 32))
        self.btn_abrir_des = QPushButton("ABRIR DESIGNER")
        self.btn_abrir_des.setIcon(QIcon(os.path.join(base_path, "icons", "open_d.svg")))
        self.btn_abrir_des.setIconSize(QSize(32, 32))
        self.btn_salvar_mod = QPushButton("SALVAR MOD")
        self.btn_salvar_mod.setIcon(QIcon(os.path.join(base_path, "icons", "save_m.svg")))
    ...
    def alternar_modo(self):
        ...
        if self.modo_modelo:
            ...
            self.btn_modo.setIcon(QIcon(os.path.join(base_path, "icons", "keyboard.svg")))
